# OTA 여행상품 기획 AI Agent - 아키텍처 문서

> **최종 갱신**: 2026-03-08 (코드베이스 역공학 기반 작성)

---

## 1. 시스템 개요

OTA(Online Travel Agency) MD(상품기획자)가 새로운 여행 패키지 상품을 기획할 때, Knowledge Graph 기반의 AI Agent가 초안 일정을 자동 생성하는 시스템이다.
...
AI가 생성한 여행 상품을 저장. 하나투어 JSON 형식과 호환되는 30+ 필드 (항공, 가격, 일정, 호텔, 보험, 약관 등).
