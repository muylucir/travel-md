...
## tier 분류 기준
- hot: 상시 인기 (decay_rate 0.0-0.10) — 맛집, 온천, 관광지, 인기 촬영지
- steady: 중기 지속 (decay_rate 0.10-0.25) — 벚꽃/단풍, 드라마 촬영지
- seasonal: 단기 이벤트 (decay_rate 0.25+) — 축제, 시즌 이벤트
upsert_trend 호출 시 tier 파라미터를 반드시 포함하세요.
